    ...
    function readercheckResult(){
        ...
        if (xmlHttp.readyState==4 && xmlHttp.status==200){
            ...
            if(getreadername == "null"){
				...
				document.getElementById("readeridcheck").innerHTML = "*正しい学籍番号を入力してください";
            }
			else{
			...
			if(getreaderstatus == "异常" && getreadername != "null"){
				document.getElementById("readerstatuscheck").innerHTML = "*該当ユーザーは異常状態の上貸出不可";
			}
			else if(getreaderborrow == "5"){
				document.getElementById("readerborrowcheck").innerHTML = "*該当ユーザーは貸出しすぎている";
			}
			else{
				document.getElementById("readerstatuscheck").innerHTML = "";
			}
	...
	function bookcheckResult(){
        ...
        if (xmlHttp.readyState==4 && xmlHttp.status==200){
            ...
            if(getbookname == "null"){
				...
				bookremain.value = "未知";
				document.getElementById("bookidcheck").innerHTML = "*正しい番号を入力してください";
            }
			else{
			...
			if(parseInt(getbookremain) == 0 && getbookname != "null"){
				document.getElementById("booknumcheck").innerHTML = "*該当書籍在庫なし";
			}
			else{
	...
	function errorsubmit(){
		...
		if (readerid == ""){
			document.getElementById("readeridcheck").innerHTML = "*学籍番号を入力してください";
			return false;
		}
		else if(bookid == ""){
			document.getElementById("bookidcheck").innerHTML = "*番号を入力してください";
			return false;
		}
